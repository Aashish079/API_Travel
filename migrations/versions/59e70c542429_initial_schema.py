...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['monument_id'], ['monument.monument_id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.user_id'], ),
    sa.PrimaryKeyConstraint('bookmark_id')
    )
    op.create_table('monument_event',
    ...
    op.create_table('monument_slot',
    sa.Column('monument_id', sa.Integer(), nullable=False),
    sa.Column('slot_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['monument_id'], ['monument.monument_id'], ),
    sa.ForeignKeyConstraint(['slot_id'], ['day_slot.slot_id'], ),
    sa.PrimaryKeyConstraint('monument_id', 'slot_id')
    )
    op.create_table('monument_tag',
    ...
    op.create_table('user_visited_monument',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('monument_id', sa.Integer(), nullable=False),
